...
export const MessageItem = React.memo(function MessageItem({ message, modelName, onReply, onEdit, onDelete, onRegenerate, onReact }: MessageItemProps): React.ReactElement {
