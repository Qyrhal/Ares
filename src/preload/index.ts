...
const nativeGit = {
  ...
  rebase:        (cwd: string, onto: string) => ipcRenderer.invoke('git:rebase', cwd, onto),
  rebaseAbort:   (cwd: string) => ipcRenderer.invoke('git:rebaseAbort', cwd),
  rebaseContinue:(cwd: string) => ipcRenderer.invoke('git:rebaseContinue', cwd),
